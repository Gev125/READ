...
<body>
    ...
    <header class="header">
        ...
        <div class="header-1">
          ...
          <a href="#"  class="logo"><i class="fas fa-book"></i>book</a>
            ...
            <div class="icons">    
                ...
                <div id="#book" class="fas fa-shopping-cart"></div>
      ...
      <div class="swiper arrivals-slider">
        <div class="swiper-wrapper">
          <a href="#" class="swiper-slide box">
            ...
            <div class="content">
              <h3>new arrivals</h3>
              <div class="price">$15.9<span>$20.99</span></div>
              <div class="stars">
      ...
      <section class="footer">
        <div class="box-container">
          ...
          <div class="box">
            ...
            <a href="#"><i class="fas fa-envelope"></i>Gevorg@gmail.com</a>
        ...
        <div class="credit">created by<span>mr. web</span> | all rights reserved! </div>
      </section>
